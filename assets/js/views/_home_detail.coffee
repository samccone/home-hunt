App.module "Views", (Views, App, Backbone, Marionette, $, _) ->
  class Views.HomeDetail extends Marionette.Layout
    ...
    onDomRefresh: ->
      ...
      @ui.map.css
        'background-image': "url(http://maps.googleapis.com/maps/api/staticmap?center=#{location}&zoom=11&size=440x90&scale=2&maptype=roadmap&sensor=false&style=hue:0x0091ff|visibility:on|weight:0.1)"
